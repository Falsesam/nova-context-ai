...
while True:
    ...
    if intent == "emotional":
        ...
        conversation_state["emotion_level"] = max(0, conversation_state["emotion_level"] - 0.2)
    ...
    response = generate_response(
        user_input, intent, mood, conversation_history, conversation_state
    )

    # to Save response:
    conversation_history[-1]["nova"] = response

    # to give typing effect:
